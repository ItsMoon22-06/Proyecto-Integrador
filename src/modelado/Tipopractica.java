 ...
 * 
 * Los tipos de prácticas definen categorías de experiencias educativas
 * organizadas
 ...
 * 
 * Esta clase es una entidad de dominio que mapea a la tabla TIPOPRACTICA en la
 * BD.
 */
public class Tipopractica {
    ...
    /**
     * Constructor parametrizado que inicializa todos los atributos del tipo de
     * práctica.
     * 
     ...
     */
    public void setNumSemestre(int v) {
        this.numSemestre = v;
    }
     ...
     */
    public void setHorasRequeridas(int v) {
        this.horasRequeridas = v;
    }
