 ...
 * durante sus prácticas pedagógicas, asignado a un programa académico
 * específico.
 * 
 * Atributo específico del tutor:
 * - idPrograma: Identificador del programa académico al que el tutor está
 * asociado
 * 
 * Esta clase es una entidad de dominio que mapea a la tabla TUTOR_ACADEMICO en
 * la BD.
 */
public class TutorAcademico extends Usuario {
    // Identificador del programa académico al que pertenece el tutor (FK →
    // Programa)
    ...
    /**
     * Constructor parametrizado que inicializa todos los atributos del tutor
     * académico.
    ...
    public TutorAcademico(String numDocumento, String tipoDocumento, String nombre,
        ...
        // Invoca el constructor parametrizado de la clase padre con los atributos
        // comunes
