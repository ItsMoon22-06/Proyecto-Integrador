...
/**
 * Clase abstracta que define los atributos y métodos comunes a todas las categorías 
 * de usuarios del sistema SIGEP (Estudiantes, Tutores Académicos, Asesores Pedagógicos).
 * 
 * Esta clase utiliza herencia para evitar duplicación de código y garantizar consistencia
 * en todos los tipos de usuarios del sistema. El modificador 'abstract' previene su 
 * instanciación directa y obliga a que las subclases implementen el método toString().
 * 
...
public abstract class Usuario {
    ...
    /**
     * Constructor vacío que crea un usuario con todos los atributos sin inicializar.
     * Se utiliza comúnmente en combinación con setters para crear objetos dinámicamente.
     */
    public Usuario() {}
