 ...
 * 
 * Esta clase no tiene atributos adicionales específicos más allá de los heredados
 * de Usuario, pero proporciona su propia representación en texto personalizada.
 * 
 * Esta clase es una entidad de dominio que mapea a la tabla ASESOR_PEDAGOGICO en la BD.
 */
public class AsesorPedagogico extends Usuario {
    ...
    /**
     * Constructor parametrizado que inicializa todos los atributos del asesor pedagógico.
    ...
    public AsesorPedagogico(String numDocumento, String tipoDocumento, String nombre,
                            ...
                            String estado) {
        // Invoca el constructor parametrizado de la clase padre con todos los parámetros
