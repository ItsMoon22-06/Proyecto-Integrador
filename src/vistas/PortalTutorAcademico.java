...
import controlador.TutorControlador;
...
public class PortalTutorAcademico extends JFrame {
    ...
    public PortalTutorAcademico(TutorAcademico tutor) {
        ...
        PanelBitacoraTutor panelBitacora = new PanelBitacoraTutor(
            practicaCardLayout, practicaContainer, true,
            tutor.getNumDocumento(), bitacoraCtrl);
        PanelPracticasTutor panelLista = new PanelPracticasTutor(
            practicaCardLayout, practicaContainer, true,
            tutor.getNumDocumento(), practicaCtrl, bitacoraCtrl, panelBitacora);
    ...
    private void buildSidebar() {
        ...
        lblPortal = new JLabel("Portal Tutor Académico"); lblPortal.setForeground(Color.LIGHT_GRAY); lblPortal.setFont(new Font("SansSerif",Font.PLAIN,12));
        ...
        toggle.setVerticalAlignment(SwingConstants.CENTER); toggle.setHorizontalAlignment(SwingConstants.CENTER);
        ...
        lblLogout.addMouseListener(new MouseAdapter() {
            @Override public void mouseClicked(MouseEvent e) {
                ...
                lw.setExtendedState(PortalTutorAcademico.this.getExtendedState());
                if (PortalTutorAcademico.this.getExtendedState() != JFrame.MAXIMIZED_BOTH) {
                    lw.setBounds(PortalTutorAcademico.this.getBounds());
                }
