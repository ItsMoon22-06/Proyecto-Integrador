...
/**
 * 
 * SIGEP — Software de Gestión de Prácticas                         
 * Pedagógicas                                                      
 * Arquitectura MVC                                                 
 ...
 * 
 * Clase principal que sirve como punto de entrada de la aplicación SIGEP.
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Esto hace que la aplicación se vea como una aplicación nativa del sistema operativo
        try {
            ...
            // Esto asegura que la aplicación pueda ejecutarse aunque falle la configuración visual
        }

        // Ejecuta el código de interfaz gráfica en el Event Dispatch Thread (EDT)
        // Swing no es thread-safe, por lo que toda operación de GUI debe ejecutarse en el EDT
        ...
        SwingUtilities.invokeLater(() -> {
             ...
             * la aplicación mostrará directamente la ventana de login sin mostrar el splash.
             *
